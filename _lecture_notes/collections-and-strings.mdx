...
Now comes the data type that is **critical** in programming - the <span class="color-purple">dictionary</span> type.
...
<span class="color-green">Terpsichorean</span> is defined in the dictionary as _"pertaining
to dancing"_. <span class="color-purple">Appoggiatura</span> is defined as _"a note
of embellishment preceding another note and taking a portion of its time"_ .
...
<LargeQuote>
  <p>
    <span class="color-green">I’m so good at finance...</span>
    <br />
