...
export default function Exercise() {
  const codingChallengeIds = [223, 224, 225, 226, 227];
    ...
    <Layout>
      <main className={styles.page}>
        <Container>
          <Row>
            <Col>
              <h1 className="pageTitle">Exercise 4</h1>
            </Col>
          </Row>
            ...
            items={[
              <>
                ...
                <span className="color-purple">
                  Thursdsay before the beginning of the class
                </span>{" "}
                (Sep 23, 3:30 PM CST) to complete this exercise.
              </>,
              <>
                You get{" "}
          ...
          <Row>
            <Col>
              <div className={styles.coverImage}>
                <Image
                  src="/images/exercises/exercise_04_cover_image.jpg"
                  width={1600}
                  height={600}
                  alt=""
                />
